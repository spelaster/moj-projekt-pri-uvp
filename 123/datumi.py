...
def stevilo_dni(mesec, leto):
    if (mesec)== (1 or 3 or 5 or 8 or 10 or 12):
        return 31
    if (mesec)== (4 or 6 or 7 or 9 or 11):
        return 30
    if(mesec)==2:
...
def _validate_current_file():
    ...
    if Check.part():
        try:
            test_data = [
                ...
                ('Datum(14, 12, 1982).razlika(Datum(23, 5, 2016))', -12214),
                ('Datum(23, 5, 2016).razlika(Datum(14, 12, 1982))', 12214),
                ('Datum(1, 1, 1982).razlika(Datum(23, 5, 2016))', -12561),
                ('Datum(23, 5, 2016).razlika(Datum(1, 1, 1982))', 12561),  
            ]
            for td in test_data:
                if not Check.equal(*td):
                    break
    ...
    try:
        ...
        token = 'Token 1f0d8e6b2013a0c2f682e8d3329b03c32dd0d591'
